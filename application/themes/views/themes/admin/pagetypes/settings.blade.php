...
<div class="ajax-message"></div>
         ...
         <div class="block header_block">
                <h4><i class="icon-wrench"></i> <?php echo Lang::line('dashboard.header_settings');?>
            ...
            <div class="block">
              <div class="row-fluid">
                <div class="span12">
                 ...
                 <h4><i class="icon-flag"></i> Language</h4> 

                  {{ Form::open('settings/language')}}

                  {{Form::select('language', $langs, $lang)}}
                   <br/> 
                  {{Form::submit('Save', array('class'=>'btn btn-primary '))}}
                  {{Form::close()}}
                   <br/>
