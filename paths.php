...
// --------------------------------------------------------------
$paths['public'] = '../../cms_core/lusocms/public/';
...
// --------------------------------------------------------------
$paths['user_bundles'] = '../../cms_user/bundles/'; 
// --------------------------------------------------------------
// The path to the user themes.
// --------------------------------------------------------------
$paths['user_themes'] = '../../cms_user/themes/';
// --------------------------------------------------------------
// The path to the files location.
// --------------------------------------------------------------
$paths['files'] = '../../cms_user/filemanager/';
// *-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-
